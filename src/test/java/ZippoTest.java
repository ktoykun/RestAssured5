...
//    https://jsonpathfinder.com/
    ...
    public void extractingJsonPath4 () {
        ...
        System.out.println("bütünIDler = " + bütünIDler);
    ...
    public void extractingJsonPath5 () {
        //https://gorest.co.in/public/v1/users dönen değerdeki bütün nameleri yazdırınız.
    ...
    public void extractingJsonPathResponseAll () {
        //https://gorest.co.in/public/v1/users dönen değerdeki bütün verlieri yazdırınız.
        ...
        Assert.assertEquals(limit, 10, "Sonuç Hatalı");
    ...
    public void extractJSONAll () {
       Location locationNesnesi= given().get("http://api.zippopotam.us/us/90210")
                        .then()
                //.log().body().
        ...
        System.out.println("locationNesnesi.getCountry()+ locationNesnesi.getPlaces() = " + locationNesnesi.getCountry());
